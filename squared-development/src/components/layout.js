...
const CloseIcon = styled.div`
  ...
  transition: 0.3s;
  transform: ${props =>
    props.menuOpened ? "translateY(0px)" : "translateY(-100px)"};
...
const HamburgerIconContainer = styled.div`
  ...
  @media (max-width: 960px) {
    transform: ${props =>
      props.menuOpened ? "translateY(-100px)" : "translateY(0px)"};
          ...
          <HeaderMainContent>
            ...
            <StyledNav>
              ...
              <Button
                ...
                to="/#references"
                link
                active={activeSectionId === "/#references"}
              >
                References
              </Button>
              <Button
