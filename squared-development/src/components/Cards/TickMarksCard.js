...
const StyledPath = styled.path`
  stroke:${props => props.strokeColor ? (props.theme.colors[props.strokeColor] ? props.theme.colors[props.strokeColor] : props.theme.colors.primary) : props.theme.colors.primary};
  stroke-width:8px;
`
              ...
              listItems.map(item => (
                <TickmarkItem>
                  <Mark>
                    {
                      item.available ?
                      <svg xmlns="http://www.w3.org/2000/svg" width="35.676" height="29.144" viewBox="0 0 35.676 29.144">
                        <StyledPath id="checkmark-outline" d="M120.375,128l-17.062,19.5L96,140.187" transform="translate(-90.343 -122.356)" fill="none" strokeColor={'success'} stroke-linecap="round" stroke-linejoin="round" stroke-width="8"/>
                      </svg>
                      :
                      <svg xmlns="http://www.w3.org/2000/svg" width="36.614" height="36.614" viewBox="0 0 36.614 36.614">
                        <StyledPath id="close-outline" d="M169.3,169.3,144,144m25.3,0L144,169.3" transform="translate(-138.343 -138.343)" fill="none" strokeColor={'error'} stroke-linecap="round" stroke-linejoin="round" stroke-width="8"/>
                      </svg>
                    }
                  </Mark>
