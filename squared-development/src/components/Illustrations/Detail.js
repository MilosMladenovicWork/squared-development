        ...
        return (
          ...
          >
            <svg
              ...
              width="100%"
              viewBox="0 0 424.537 424.537"
            >
              <g
                id="Group_31"
                data-name="Group 31"
                transform="translate(-1445.897 -4265.975) rotate(45)"
                opacity="0.19"
              >
                <StyledRect
                  data-testid="styled-rect"
                  id="Rectangle_69"
                  data-name="Rectangle 69"
                  width="121.953"
                  height="121.953"
                  transform="translate(4189 1965.953) rotate(-90)"
                />
                <StyledRect
                  data-testid="styled-rect"
                  id="Rectangle_70"
                  ...
                  width="121.953"
                  height="121.953"
                  transform="translate(4367.239 1965.953) rotate(-90)"
                />
                <StyledRect
                  data-testid="styled-rect"
                  id="Rectangle_71"
                  ...
                  width="121.953"
                  height="121.953"
                  transform="translate(4189 2144.193) rotate(-90)"
                />
                <StyledRect
                  data-testid="styled-rect"
                  id="Rectangle_72"
                  ...
                  width="121.953"
                  height="121.953"
                  transform="translate(4367.239 2144.193) rotate(-90)"
                />
              </g>
            </svg>
          </DetailContainer>
