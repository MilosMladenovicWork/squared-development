...
const WavyLinesBackground = ({fillColor, ...props}) => {
  ...
  const createLine = (startPosition, duration) => {
    return <TranslateContainer startPosition={startPosition} duration={duration}>
        ...
        <StyledPath fillColor={fillColor} id="WavyLine" d="M181.636,5167.748s288.332-224.217,597.24,0,691.327,0,691.327,0,198.254-158.629,576.787,0,711.78,0,711.78,0,282.258-234.565,666.782,0" transform="translate(-178.567 -5058.459)" fill="none" stroke-width="10" opacity="0.24"/>
      </StyledSvg>
      </TranslateContainer>
  }
