...
describe('CurvedBackground', () => {
  const CurvedBackgroundWithTheme = ({...props}) => <ThemeProvider theme={theme}>
  ...
  describe('StyledPath', () => {
    ...
    it('accepts fillColor prop', () => {
      const {getAllByTestId} = render(<CurvedBackgroundWithTheme fillColor="accent"/>)
  ...
  describe('IllustrationBody', () => {
    ...
    it('accepts fillColor prop', () => {
      const {getByTestId} = render(<CurvedBackgroundWithTheme fill="textDark"/>)
