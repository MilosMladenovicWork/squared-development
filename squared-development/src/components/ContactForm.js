...
const StatusMessage = styled.p`
  ...
  padding:15px 10px;
  text-align:center;
  background:${props => props.fillColor ? (props.theme.colors[props.fillColor] ? props.theme.colors[props.fillColor] : props.theme.colors.primary) : props.theme.colors.primary};
...
const ContactForm = () => {
  ...
  return(
    <StyledContactForm>
      ...
      {errorMessage && (
        <StatusMessage fillColor={'error'}>
          {errorMessage}
        </StatusMessage>
      )}
      {
        successMessage && (
        <StatusMessage fillColor={'success'}>
          {successMessage}
        </StatusMessage>
        )
      }
