...
const TextareaInput = ({name, value, onChange, placeholder, textColor, ...rest}) => {
  return(
    <StyledTextarea type='text' required name={name} textColor={textColor} onChange={e => onChange(e.target.value)} {...rest} placeholder={placeholder}></StyledTextarea>
  )
}
