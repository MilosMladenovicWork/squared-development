...
const IndexPage = ({ activeSection: activeSectionStore }) => {
  ...
  const [toggleReferencesBackground, setToggleReferencesBackground] = useState(
    false
  )
  ...
  const { perun, minus1, runbgd, cubical, helloClean, mathGame } = imagesData
    ...
    <Layout>
      ...
      <ConstraintContainer>
        <FullHeightContainer>
          <ReactVisibilitySensor
            partialVisibility
            offset={{
              top: typeof window !== "undefined" && window.innerHeight / 2,
            }}
                ...
                <PercentageWidthContainer widthPercentage={45}>
                  <HeroHeadingContainer>
                    <Heading alignment={"left"}>
                      {`We create `}
                      <TimedElementsAppear
                        elements={["Websites", "Applications", "Graphics"]}
                      />
                    </Heading>
                  </HeroHeadingContainer>
                  <HeroDescriptionContainer>
                    <Paragraph display>
                      We develop professionally designed, fast and attention
                      grabbing websites and web applications.
                    </Paragraph>
                  </HeroDescriptionContainer>
                  <VerticalMarginSeparator marginSize={2}>
                    <HeroButtons>
                      ...
                      <Button as={Link} to="/#projects" secondary>
                        See our work
                      </Button>
                    </HeroButtons>
      ...
      <RelativeFullWidthContainer>
        ...
        <ConstraintContainer>
          <ReactVisibilitySensor
            ...
            onChange={isVisible =>
              handleSectionVisibility(isVisible, "/#services")
            }
          >
            <section>
              ...
              <Paragraph halfWidth display alignment={"center"}>
                We provide everything you need for your company website so you
                can focus on what matters the most, your product. Also, you are
                going to get exactly what you need in time interval that you
                set. We are web development company which focuses on using
                ReactJS for creating highly interactive websites. Our web
      ...
      <AboutContentContainer>
        ...
        <ConstraintContainer>
          <ReactVisibilitySensor
            ...
            onChange={isVisible =>
              handleSectionVisibility(isVisible, "/#about")
            }
          >
            <section id="about">
              <AboutContentContainer>
                ...
                <PercentageWidthContainer widthPercentage={40}>
                  <Heading alignment={"right"} accent textColor="textLight">
                    About us
                  </Heading>
                  <Paragraph alignment={"right"} textColor="textLight">
                    We are team of developers and designers with a mission of
                    creating engaging and user friendly websites and web
                    applications.
                  </Paragraph>
                  <VerticalMarginSeparator marginSize={0.25} />
                  <Paragraph alignment={"right"} textColor="textLight">
                    We are web development, web design and web application
                    development company that is also working outside of web
                    platforms, making designs for bussiness cards, illustrations
                    and more. We strive to become best web development agency in
                    a region and beyond.
                  </Paragraph>
                  <VerticalMarginSeparator marginSize={0.25} />
                  <Paragraph alignment={"right"} textColor="textLight">
                    With use of latest technologies we are creating websites
                    that can stand test of time with good design and appear on
      ...
      <RelativeFullWidthContainer>
        ...
        <ConstraintContainer>
          <ReactVisibilitySensor
            ...
            onChange={isVisible =>
              handleSectionVisibility(isVisible, "/#pricing")
            }
          >
            <section>
              <Heading alignment={"center"} accent>
              ...
              <Paragraph halfWidth display alignment={"center"}>
                We divided price ranges in three web development packages with
                different included services, but feel free to contact us so we
                can negotiate the price. We strive to make web development
                services affordable for our clients.
              </Paragraph>
              <ServicesCardsContainer>
                <TickMarksCard
                  heading="Basic"
                  ...
                  icon={cardHovered => (
                    ...
                    >
                      <StyledPath
                        fillColor={cardHovered ? "accent" : "textDark"}
                        id="albums"
                  ...
                  icon={cardHovered => (
                    ...
                    >
                      <StyledPath
                        fillColor={cardHovered ? "accent" : "textDark"}
                        id="albums"
                        d="M400,144H112a16,16,0,0,1,0-32H400a16,16,0,0,1,0,32Zm19.13,304H92.87A44.92,44.92,0,0,1,48,403.13V204.87A44.92,44.92,0,0,1,92.87,160H419.13A44.92,44.92,0,0,1,464,204.87V403.13A44.92,44.92,0,0,1,419.13,448Z"
      ...
      <RelativeFullWidthContainer>
        ...
        <ConstraintContainer>
          <ReactVisibilitySensor
            ...
            onChange={isVisible =>
              handleSectionVisibility(isVisible, "/#projects")
            }
          >
            <section id="projects">
      ...
      <RelativeFullWidthContainer>
        <ReactVisibilitySensor
          ...
          onChange={isVisible =>
            handleSectionVisibility(isVisible, "/#references")
          }
        >
          <section id="references">
            <ReferencesBackgroundContainer toggle={toggleReferencesBackground}>
              {referenceSectionImage &&
                referenceSectionImage.childImageSharp &&
                referenceSectionImage.childImageSharp.fluid && (
                  <Image
                    fluid={referenceSectionImage.childImageSharp.fluid}
                    alt=""
                  />
                )}
                ...
                data={[
                  {
                    ...
                    text:
                      "Definetely top notch! Looking forward to the next project!",
                    button: "Perun",
                    buttonLink: "https://perun.network",
                    projectImg: perun,
                  },
